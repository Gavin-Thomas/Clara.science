...
const styles = ['Cartoon', 'Minimalist', 'Scene Sketch'];
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-6 h-fit sticky top-8">
      ...
      <div className="text-xs text-gray-500 text-center -mt-4 px-2">
        <p>
          Disclaimers: Topics in anatomy don't work very well, whereas topics in internal medicine, pharmacology, and microbiology, are strengths.
        </p>
        <p className="mt-2">
          The image generation agent may generate text on the image that is incorrect or misspelled.
        </p>
      </div>
